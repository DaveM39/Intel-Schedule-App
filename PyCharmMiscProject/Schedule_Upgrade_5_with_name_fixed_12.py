...
class ScheduleApp:
    ...
    def __init__(self, root: ttk.Window):
        ...
        self.active_filter = None  # NEW: To track the active filter
        self.legend_labels = {}  # NEW: To store legend labels for styling
        ...
        # NEW: Fonts for the legend to show active state
    ...
    def _build_legend(self, parent):
        ...
        self.legend_labels = {}  # Clear any previous labels
        for name, col in self.colors.items():
            ...
            self.legend_labels[name] = label  # Store the label for styling
    ...
    def _update_legend_visuals(self):
        """NEW: Bolds the active filter label and un-bolds others."""
    ...
    def _update_calendar_display(self):
        """Uses a colored tk.Frame behind the Label for robust coloring."""
        ...
        for i in range(1, 13):
            ...
            for week_idx in range(TARGET_WEEKS_PER_MONTH_DISPLAY):
                for day_idx in range(7):
                    ...
                    day_frame.grid(row=week_idx + 2, column=day_idx, sticky="nsew")
                    ...
                    day_label.pack(expand=YES, fill=BOTH, padx=1, pady=1)
