...
class ScheduleApp:
    ...
    def _build_widgets(self):
        ...
        # COMPATIBILITY FIX: Manually insert date string into the sub-widget
    ...
    def save_schedule_data(self, file_path):
        # COMPATIBILITY FIX: Get date string directly from the entry sub-widget
    ...
    def load_schedule_data(self, file_path):
        try:
            ...
            # COMPATIBILITY FIX: Manually update the entry sub-widget's text
    ...
    def calculate_dates(self):
        # COMPATIBILITY FIX: Use the safe helper function to get the date
